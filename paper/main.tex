...
The Trika RSSM (Phase 1, levels=1) achieved VFE = \textbf{0.60} on the
4{,}936-file mixed corpus after 10{,}000 training steps, compared to
VFE = 0.955 with random observations and VFE = \{LSTM\_MSE\} for the
LSTM baseline.
UMAP of $z_t$ latents shows \{silhouette\} cluster separation by domain
(philosophy / gutenberg / poetry).

% TODO: Insert Figure 1 (UMAP) and Figure 2 (VFE learning curve).
