...
Gate results pending full 400K-step run (expected 2026-05-09 23:00).

\paragraph{Diagnostic summary: six-layer H1 failure chain.}
Table~\ref{tab:h1_diagnosis} summarises all compounding failure layers.
Each layer was identified by post-mortem checkpoint analysis; v7 targets Layer~6.

\begin{table}[h]
  \caption{H1 Failure Diagnostics — Six Compounding Layers}
