...
\emph{Interim results at step~20{,}900 (10{,}900 post-freeze):}
critic CE $= 1.66$ (declined from $6.7$ at WM freeze; consistent decline of ${\approx}0.05$/1K steps,
versus flat CE $=3.4$ throughout 29K post-freeze steps of v10),
\texttt{ret}$\,\in[+3,+8]$ (positive, mean ${\approx}4.5$; actor learning committed domain strategies),
\texttt{adv\_scale}$\,=38$ (discriminative rewards active), \texttt{sps}$\,=14.5$.
Gate ETA: step~400{,}000 at ${\approx}21$:43 UTC 2026-05-10.

\paragraph{Diagnostic summary: ten-layer H1 failure chain.}
...
\begin{table}[h]
  \caption{H1 Failure Diagnostics — Ten Compounding Layers}
...
Phase 2 WM (seed=49, warm-start from Phase 2 v7 final).
...
shows consistent convergence: critic CE $1.66$ and \texttt{ret}${}\in[+3,+8]$ at step~20{,}900
(vs.\ flat CE $=3.4$ and zero-mean returns throughout 29K post-freeze steps of v10).
Phase 2 v11 is currently training; the H1 gate runs at step~400{,}000 (ETA ${\approx}$21:43 UTC 2026-05-10).
