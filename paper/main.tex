...
Ollama at \texttt{localhost:11434}) on 13 creative specifications spanning
Sanskrit, Kannada, and English poetry and song.
...
All 13 outputs were scored with the camatkāra heuristic
$R_{\text{camatk}} = 0.30 \cdot R_{\text{VFE}} + 0.25 \cdot R_{\text{term}}
+ 0.25 \cdot R_{\text{len}} + 0.20 \cdot R_{\text{struct}} + \delta_{\text{div}}$
where $R_{\text{VFE}}$ rewards low world-model free energy, $R_{\text{term}}$ rewards
domain-specific terminology (Sanskrit/Kannada/English rasa vocabulary),
$R_{\text{len}}$ rewards sufficient poetic development, and $R_{\text{struct}}$
rewards structural forms (metre, pallavi, verse/chorus).
Mean $R_{\text{camatk}} = 0.878$ across 13 outputs (range $0.851$–$0.903$).
The highest-scoring output was l03 (Jazz Spiritual, $0.891$) due to its four-movement
architecture satisfying both structural and terminological criteria.
...
We release all code, configurations, trained checkpoints for all six phases,
