...
steps ($\Delta\text{enc} = 0.000$ from steps 10{,}100--13{,}200+), and throughput
recovered to 10.1~steps/s.
...
Gate results pending full 400K-step run (seed=49, expected 2026-05-10 02:10~UTC).

\paragraph{Diagnostic summary: seven-layer H1 failure chain.}
...
\begin{table}[h]
  \caption{H1 Failure Diagnostics — Seven Compounding Layers}
