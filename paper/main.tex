...
(threshold: 1.10, PASS);
(H3) sleep consolidation shows negligible catastrophic forgetting in both
conditions (PASS); Phase~5 (vimarśa bridge, H4--H6) is in training.
...
\begin{table}[h]
  ...
  \begin{tabular}{llll}
    ...
    H4 & Vimarśa improves narration        & $\geq$70\% sphurattā  & Pending \\
    H5 & PWM $>$ PCE v0.4                  & $R_{\text{camatk}}$ density & Pending \\
    H6 & Camatkāra: reward entropy         & Entropy $>$ 0.5 nats  & Pending \\
...
\emph{Results pending Phase 5 training.}
