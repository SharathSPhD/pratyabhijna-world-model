...
\paragraph{Phase 2 v9: domain-affinity reward (training, 2026-05-10).}
...
Training launched 2026-05-10, seed=50, warm-start from Phase~1 checkpoint.
\emph{Results pending.}

\paragraph{Diagnostic summary: eight-layer H1 failure chain.}
...
\begin{table}[h]
  \caption{H1 Failure Diagnostics — Eight Compounding Layers}
...
The eight-layer failure chain constitutes an unusually complete negative-result case study
...
and the forthcoming decoder-only-$z_t$ fix (Layer 6, v7),
...
Phase 2 has identified an eight-layer compounding failure chain through iterative
...
Phase 2 v9 (domain-affinity reward, seed=50) is currently training.
