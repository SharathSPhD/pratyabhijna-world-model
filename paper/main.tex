...
by step~10K, $\mathbf{W}_a$ has norm 0.52, $\cos\!\sin = -1.0$,
and encoder norm is $\approx 2.49$ (healthy).
...
Gate results pending full 400K-step run (seed=49, expected 2026-05-10 01:00~UTC).
