...
\emph{Results at step~14{,}700 (4{,}700 post-freeze):}
critic CE $= 2.18$ (declining from $6.7$; rapid learning of new reward distribution),
\texttt{ret}$\,=+8.45$ (positive, oscillating; actor exploring committed strategies),
\texttt{adv\_scale}$\,=32$ (discriminative rewards active).
...
v11 (actual imagination actions, seed=52, warm-start from step-10K checkpoint)
shows immediate convergence: \texttt{ret}$\,=+21$ and critic CE $=2.10$ at step~12{,}000
(vs.\ zero-mean returns and flat CE throughout 29K steps of v10).
Phase 2 v11 is currently training toward the H1 gate at step~400{,}000.
